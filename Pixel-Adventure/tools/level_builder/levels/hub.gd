...
## có AI (Cố vấn đứng gác chỉ cổng mục tiêu, Dân làng đi tuần + bám theo, Heo đào ngũ
## bỏ chạy khi bị doạ), bia truyền thuyết và biển chọn màn. Không quái, không cờ.
...
func define() -> void:
	...
	legend = {
		...
		"V": {"type": "npc", "name": "Villager", "speaker": "Dân làng", "dynamic_line": 2, "behavior": 1,
			"wander_range": 60.0, "walk_speed": 24.0, "idle_frames": "res://player/sprites/King/king_frames.tres",
			"sprite_faces_right": true, "modulate": Color(0.72, 0.74, 0.82, 1),
		...
		"D": {"type": "npc", "name": "Deserter", "speaker": "Heo đào ngũ", "dynamic_line": 3, "behavior": 2,
			"flee_radius": 72.0, "calm_time": 1.2, "walk_speed": 22.0, "modulate": Color(0.82, 0.95, 0.78, 1),
			"line_1": "Suỵt! Đừng hét. Tôi bỏ hàng ngũ Vua Heo rồi, thề đấy.",
