...
func define() -> void:
	...
	rect(72, 13, 74, 14, ".")      # lỗ trên mái để leo ra
	at(46, 5, "2")
	at(49, 5, "W")
	text(51, 5, "3")
	at(54, 12, "X")
	...
	# E — tháp canh -------------------------------------------------------------------
	rect(120, 0, 135, 14)
	rect(120, 18, 121, 40)         # tường trái (cửa ở dưới)
	rect(134, 15, 135, 40)         # tường phải
	at(121, 15, "W")
	back(122, 15, 133, 36)
	rect(128, 18, 133, 18)
	rect(122, 21, 127, 21)
	...
	rect(128, 30, 133, 30)
	rect(122, 33, 127, 33)
	rect(120, 37, 135, 38)         # mái tháp
	rect(129, 37, 133, 38, ".")    # lỗ ra mái
	at(125, 20, "B")
	at(130, 23, "V")
	at(125, 32, "B")
	at(133, 22, "<")
