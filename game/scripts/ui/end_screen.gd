...
const WIN_PANEL_TEXTURE := preload("res://assets/ui/panels/dialog_tan.png")
## Ảnh nền lát nền (tile) cho từng trạng thái: xám trầm khi thua, vàng ấm khi thắng
const LOSE_BG_TEXTURE := preload("res://assets/backgrounds/Gray.png")
const WIN_BG_TEXTURE := preload("res://assets/backgrounds/Yellow.png")
...
func _on_retry() -> void:
	...
	SceneTransition.goto("res://scenes/levels/level_1.tscn")
