...
## Playable characters, matching the folder names in player/sprites/.
...
## Đường dẫn tới file SpriteFrames đã bake sẵn (idle/run/jump/...) của nhân vật,
## xem player/sprites/<character>/<character>_frames.tres.
